// src/components/HeightControl.tsx
...
export const HeightControl: React.FC<HeightControlProps> = ({
    ...
    const step = 1;
    const dec = () => onChange(Math.max(min, height - step));
    const inc = () => onChange(Math.min(max, height + step));
    ...
    return (
        <div className="flex flex-col space-y-2 w-full items-start">
            ...
            <div className="flex w-full justify-center items-center space-x-[1rem] mt-[0.5rem]">
                ...
                <span className="w-20 text-center font-semibold">{height} cm</span>
